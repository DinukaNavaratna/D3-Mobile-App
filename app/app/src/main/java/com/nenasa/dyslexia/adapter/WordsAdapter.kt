package com.nenasa.dyslexia.adapter
...
import com.nenasa.R
import com.nenasa.dyslexia.callback.DragListener
import com.nenasa.dyslexia.callback.WordsDiffCallback
...
class WordsAdapter(private val onDragStarted: (String) -> Unit) : ListAdapter<String, WordsAdapter.WordsViewHolder>(WordsDiffCallback()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WordsViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.dyslexia_item_word, parent, false)
